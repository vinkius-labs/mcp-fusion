...
::: info Attribution
**MVA (Model-View-Agent)** was created by [Renato Marinho](https://github.com/renatomarinho) at [Vinkius Labs](https://github.com/vinkius-core) and first implemented in [**MCP Fusion**](https://github.com/vinkius-core/mcp-fusion). It is not a fork, extension, or "variation" of MVC — it is a fundamentally new architecture designed for a fundamentally new consumer class.
:::
