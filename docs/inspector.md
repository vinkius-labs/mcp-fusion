...
description: Zero-overhead real-time terminal dashboard for MCP Fusion servers. Connects via Shadow Socket (IPC) — no stdio interference, no port conflicts, no agent disruption.
---
